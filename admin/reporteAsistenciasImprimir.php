				  ...
				  <div class="card-body">
					<form class="form-inline theme-form mt-3" name="form1" method="post" action="reporteAsistencias.php">
					  <div class="form-group mb-0">
						Fecha Desde:&nbsp;<input class="form-control" type="date" name="fechaDesde" value="<?php echo $_POST['fechaDesde']; ?>" readonly="readonly">
					  </div>
					  <div class="form-group mb-0">
						Fecha Hasta:&nbsp;<input class="form-control" type="date" name="fechaHasta" value="<?php echo $_POST['fechaHasta']; ?>" readonly="readonly">
					  </div>
					</form>
				</div>
			  </div>

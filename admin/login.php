...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="card mt-4">
                    <div class="card-body">
					  ...
					  <form class="theme-form" role="form" name="flogin" action="login.php" method="post">
						...
						<hr>
						<div class="form-group form-row mt-3 mb-0">
						  <button class="btn btn-success" type="button" onclick="registrarIngreso();">Registrar mi Ingreso</button>&nbsp;
						  <button class="btn btn-danger"  type="button" onclick="registrarSalida();">Registrar mi Salida</button>
						</div>
                      </form>
                    </div>
                  </div>
	...
	function registrarIngreso() {
		document.flogin.action = "registrarIngreso.php";
		document.flogin.submit();
	}
	function registrarSalida() {
		document.flogin.action = "registrarSalida.php";
		document.flogin.submit();
	}
	</script>

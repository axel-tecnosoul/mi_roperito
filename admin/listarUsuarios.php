                      ...
                      <table class="display" id="dataTables-example666">
                        ...
                        <tbody>
                          <?php 
							...
							$sql = " SELECT u.`id`, u.`usuario`, p.`perfil`, a.`almacen`, u.`activo` FROM `usuarios` u inner join perfiles p on p.id = u.id_perfil left join almacenes a on a.id = u.id_almacen WHERE 1 ";

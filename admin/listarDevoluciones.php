...
<html lang="en">
  ...
  <body class="light-only">
	...
	<?php 
	$pdo = Database::connect();
	$sql = " SELECT `id` FROM `devoluciones` WHERE 1 ";
	foreach ($pdo->query($sql) as $row) {
	?>
	<div class="modal fade" id="eliminarModal_<?php echo $row[0];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">¿Está seguro que desea eliminar esta devolución?</div>
		  <div class="modal-footer">
			<a href="eliminarDevolucion.php?id=<?php echo $row[0];?>" class="btn btn-primary">Eliminar</a>
			<a onclick="document.location.href='listarDevoluciones.php'" class="btn btn-light">Volver</a>
		  </div>
		</div>
	  </div>
	</div>

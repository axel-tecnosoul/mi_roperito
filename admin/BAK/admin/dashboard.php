				  ...
				  <div class="card-body">
					<div class="chart-widget-dashboard">
					  <div class="media">
						...
						$pdo = Database::connect();
						$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "SELECT sum(vd.`subtotal`) total FROM `ventas_detalle` vd inner join ventas v on v.id = vd.id_venta WHERE v.anulada = 0 and vd.`id_modalidad` = 3 and vd.`pagado` = 0 ";
						$q = $pdo->prepare($sql);
						$q->execute();
						$data = $q->fetch(PDO::FETCH_ASSOC);
				  ...
				  <div class="card-body">
					<div class="chart-widget-dashboard">
					  <div class="media">
						...
						$pdo = Database::connect();
						$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "SELECT sum(vd.`subtotal`) total FROM `ventas_detalle` vd inner join ventas v on v.id = vd.id_venta WHERE v.anulada = 0 and vd.`id_modalidad` = 2 and vd.`pagado` = 0 ";
						$q = $pdo->prepare($sql);
						$q->execute();
						$data = $q->fetch(PDO::FETCH_ASSOC);
				  ...
				  <div class="card-body">
					<div class="chart-widget-dashboard">
					  <div class="media">
						...
						$pdo = Database::connect();
						$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
						$sql = "SELECT sum(vd.`subtotal`) total FROM `ventas_detalle` vd inner join ventas v on v.id = vd.id_venta WHERE v.anulada = 0 and vd.`id_modalidad` = 2 and vd.`pagado` = 1 ";
						$q = $pdo->prepare($sql);
						$q->execute();
						$data = $q->fetch(PDO::FETCH_ASSOC);

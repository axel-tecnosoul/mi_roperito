<?php
	...
	if ( !empty($_POST)) {
		...
		$sql = "INSERT INTO `usuarios`(`usuario`, `clave`, `activo`, `id_perfil`, `id_almacen`) VALUES (?,?,1,?,?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($_POST['usuario'],$_POST['clave'],$_POST['id_perfil'],$_POST['id_almacen']));
                      ...
                      <div class="row">
                        <div class="col">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
								<select name="id_almacen" id="id_almacen" class="js-example-basic-single col-sm-12" disabled="disabled">
								<option value="">Seleccione...</option>
								<?php 
								$pdo = Database::connect();
								$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

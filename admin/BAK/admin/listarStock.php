                        ...
                        <tbody>
                          <?php 
							...
							foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row[7] . '</td>';
								echo '<td>';
									echo '<a href="modificarStock.php?id='.$row[0].'"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Ajustar Cantidad" title="Ajustar Cantidad"></a>';
								echo '</td>';
								echo '</tr>';
						   }
						   Database::disconnect();

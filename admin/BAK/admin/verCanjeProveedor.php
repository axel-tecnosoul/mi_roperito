<?php
	...
	if ( null==$id ) {
		header("Location: listarCanjesProveedor.php");
	}
				  ...
				  <form class="form theme-form" role="form" method="post" action="#">
                      ...
                      <div class="row">
                        <div class="col">
							<div class="form-group row">
								<label class="col-sm-3 col-form-label">Fecha Hora Canje</label>
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
                        <a onclick="document.location.href='listarCanjesProveedor.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>

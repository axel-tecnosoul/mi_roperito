                          ...
                          <?php 
							...
							foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>';
									...
									echo '&nbsp;&nbsp;';
									echo '<a target="_blank" href="etiquetarProducto.php?cb='.$row[8].'&codigo='.$row[1].'&nombre='.$row[3].'&precio='.$row[6].'"><img src="img/pdf.png" width="24" height="25" border="0" alt="Etiquetar" title="Etiquetar"></a>';
									echo '&nbsp;&nbsp;';
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			<a href="eliminarProducto.php?id=<?php echo $row[0];?>" class="btn btn-primary">Eliminar</a>

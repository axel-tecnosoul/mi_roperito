                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Modificar Empleado</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
				  ...
				  <form class="form theme-form" role="form" method="post" action="modificarEmpleado.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
              ...
              <div class="form-group row">
								...
								<div class="col-sm-9"><input name="domicilio" type="text" maxlength="99" class="form-control" value="<?php echo $data['domicilio']; ?>" required="required"></div>
							</div>
              <div class="form-group row">
								<label class="col-sm-3 col-form-label">Email</label>
								<div class="col-sm-9"><input name="email" type="text" maxlength="99" class="form-control" value="<?php echo $data['email']; ?>" required="required"></div>
							</div>
              <div class="form-group row">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
						...
						<a onclick="document.location.href='listarEmpleados.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>

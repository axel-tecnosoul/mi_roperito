...
if ( !empty($_POST)) {
  ...
  //$sql = "UPDATE movimientos_caja_grande SET fecha_hora = ?, monto = ?, id_forma_pago = ?, id_usuario = ?, id_motivo = ?, detalle = ?, id_almacen = ?, tipo_movimiento = ? WHERE id = ?";
  ...
  $pdo = Database::connect();
  $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  //$sql = "SELECT fecha_hora,monto,id_forma_pago,id_usuario,id_motivo,detalle,id_almacen,tipo_movimiento FROM movimientos_caja_grande WHERE id = ? ";
                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Modificar movimiento de caja grande</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Modificar movimiento de caja grande</h5>
                  </div>
				          <form class="form theme-form" role="form" method="post" action="modificarMovimientoCajaGrande.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
    ...
    <script>
      $(document).ready(function () {
        $("input[name='tipo_movimiento']").on("change",function(){
          ...
          selectMotivo.val("");
          let optionSalidaCajaGrande=selectMotivo.find("option[value='2']");

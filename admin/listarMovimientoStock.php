                    ...
                    <div class="dt-ext table-responsive">
                      <table class="display" id="dataTables-example666">
                        ...
                        <tbody><?php 
                          ...
                          $sql = " SELECT sm.id,p.descripcion,(SELECT almacen FROM almacenes a WHERE a.id=sm.id_almacen_origen) AS almacen_origen,(SELECT almacen FROM almacenes a WHERE a.id=sm.id_almacen_destino) AS almacen_destino,cantidad,u.usuario,fecha_hora FROM stock_movimientos sm INNER JOIN productos p ON sm.id_producto=p.id INNER JOIN usuarios u ON sm.id_usuario=u.id ORDER BY fecha_hora ASC";

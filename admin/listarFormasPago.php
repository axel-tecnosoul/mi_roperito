              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Formas de pago&nbsp;<a href="nuevoFormaPago.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a></h5><span>
                  </div>
                  <div class="card-body">
                            ...
                            <div class="modal fade" id="eliminarModal_<?php echo $row[0];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">¿Está seguro que desea eliminar la forma de pago?</div>
                                  <div class="modal-footer">
                                    <a href="eliminarFormaPago.php?id=<?php echo $row[0];?>" class="btn btn-primary">Eliminar</a>

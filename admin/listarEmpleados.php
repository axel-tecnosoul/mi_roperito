              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Empleados&nbsp;<a href="nuevoEmpleado.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a></h5><span>
                  </div>
                  <div class="card-body">
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			<a href="eliminarEmpleado.php?id=<?php echo $row[0];?>" class="btn btn-primary">Eliminar</a>

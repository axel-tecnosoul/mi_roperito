                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Tipos de Motivos</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
                      ...
                      <table class="display" id="dataTables-example666">
                        ...
                        <tbody>
                          <?php 
							...
							$sql = " SELECT id, nombre FROM tipos_motivos WHERE 1 ";
							...
							foreach ($pdo->query($sql) as $row) {
								...
								echo '<td>'. $row[1] . '</td>';
								echo '<td>';
									echo '<a href="modificarTipoMotivo.php?id='.$row[0].'"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Modificar" title="Modificar"></a>';
									echo '&nbsp;&nbsp;';
